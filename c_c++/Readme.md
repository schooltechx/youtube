...
## ANSI C
เป็นข้อกำหนดมาตรฐานสำหรับการเขียนโปรแกรมด้วยภาษาซี (C language) ที่สถาบันแอนซี (ANSI) เป็นผู้กำหนดไว้ บริษัทที่ผลิตตัวแปลภาษาซี (C compiler) 
เมื่อทำตามมาตรฐานนี้ จะรองรับระบบปฎิบัติการหลายตัว (DOS, Windows, macOS, UNIX, Linux ฯลฯ) จะเป็นฟังก์ชั่นการทำงานทั่วไปไม่อิงกับระบบปฎิบัติการมากนัก

### stdio
จะอยู่ใน stdio.h กำหนดชนิดตัวแปร size_t, FILE, fpos_t มี macros และ ฟังก์ชั่น อีกหลายตัวเพื่อจัดการ input และ output
...
### stdlib
จะอยู่ใน stlib.h กำหนดชนิดตัวแปร(size_t, wchar_t,div_t, ldiv_t) มี macros และ ฟังก์ชั่น อีกหลายตัวเพื่อ 
atof,atoi, atol,strtod,strtol,strtoul,*calloc,free,*malloc,*realloc,
[abort](./ANSI/abort.md),
[exit,_exit,atexit](./ANSI/exit-exit-atexit.md),*getenv,system,*bsearch,qsort,abs,div,labs,ldiv,rand, srand, mblen,mbstowcs,
mbtowc,wcstombs,wctomb
[assert](./ANSI/assert.md),

### string, memory
จัดการข้อความและหน่วยความจำ มุมมองของภาษา C คือ ข้อความคืออาเรย์ของตัวอักษรในหน่วยความจำก็เลยมีความเกี่ยวเนื่องกัน
...
### ctype
ใช้ ctype.h เป็นฟังก์ชั่นเกี่ยวกับการทดสอบและแปลงตัวอักษร
...
ถือว่าฟังก์ชั่นจะครอบคลุม ANSI ไปด้วย การมีมาตรฐานนี้ทำให้โค้ดภาษา C ในระดับที่ลึกกว่า ANSI C สามารถใช้งานข้ามระบบปฎิบัติการได้
Windows ไม่ใช่ระบบปฎิบัติการแบบ Unix-like ก็จะมีข้อจำกัดมากกว่าจะรองรับฟังก์ชั่น command line เพียงบางส่วน อาจจะต้องมีตัวช่วยเช่น 
- "Windows Subsystem for Linux"
- Cygwin  
- WSL2 ซึ่งเป็น kernel Linux ที่ทำงานบน Windows ทำให้รองรับ POSIX ได้ดียิ่งขึ้น
